...
<p>I used moment.js to get the time and date, and openweather to get the weather information on this page. I used jQuery to write the code, and dynamically add elements to the page. The buttons on the side are some example cities that, if selected, will show the current weather for that day. Local storage is used to keep track of previous searches, added function that renders previous searches as buttons when you click on search box.</p>
